...
const CLERK_CARDS: Card[] = [
  // 文档攻击
  {
    ...
    rarity: CardRarity.Common,
    cost: 1,
    description: '造成 8 点伤害，获得 1 层流程。',
    effect: { damage: 8, applyBuff: { name: BUFFS.PROCESS, stacks: 1 } },
  ...
  },
  {
    ...
    rarity: CardRarity.Common,
    cost: 1,
    description: '造成 12 点伤害，获得 1 层流程。',
    effect: { damage: 12, applyBuff: { name: BUFFS.PROCESS, stacks: 1 } },
    assetKey: 'card-doc_attack+',
  },
  // 流程防御
  {
    ...
    rarity: CardRarity.Common,
    cost: 1,
    description: '获得 6 点护甲，每层流程额外获得 1 点护甲。',
    effect: { block: 6, special: 'block_per_process_1' },
  ...
  },
  {
    ...
    rarity: CardRarity.Common,
    cost: 1,
    description: '获得 8 点护甲，每层流程额外获得 2 点护甲。',
    effect: { block: 8, special: 'block_per_process_2' },
    assetKey: 'card-process_defense+',
  },
  // 会议拖延
  {
    ...
    cost: 1,
    description: '敌人下回合无法行动（缠绕），获得 2 层流程。',
    effect: { applyDebuff: { name: DEBUFFS.ENTANGLED, stacks: 1 }, applyBuff: { name: BUFFS.PROCESS, stacks: 2 } },
  ...
  // 繁文缛节
  {
    ...
    rarity: CardRarity.Rare,
    cost: 2,
    description: '对所有敌人施加 2 层易伤，获得 3 层流程。',
    effect: { applyDebuff: { name: DEBUFFS.VULNERABLE, stacks: 2 }, special: 'all_enemies', applyBuff: { name: BUFFS.PROCESS, stacks: 3 } },
    upgradedId: 'red_tape+',
  ...
  },
  {
    ...
    rarity: CardRarity.Rare,
    cost: 2,
    description: '对所有敌人施加 3 层易伤，获得 4 层流程。',
    effect: { applyDebuff: { name: DEBUFFS.VULNERABLE, stacks: 3 }, special: 'all_enemies', applyBuff: { name: BUFFS.PROCESS, stacks: 4 } },
    assetKey: 'card-red_tape+',
  },
  // 归档管理
  {
    ...
    cost: 1,
    description: '获得 5 点护甲，抽 2 张牌，获得 2 层流程。',
    effect: { block: 5, drawCards: 2, applyBuff: { name: BUFFS.PROCESS, stacks: 2 } },
  ...
  },
  {
    ...
    rarity: CardRarity.Epic,
    cost: 1,
    description: '获得 8 点护甲，抽 2 张牌，获得 3 层流程。',
    effect: { block: 8, drawCards: 2, applyBuff: { name: BUFFS.PROCESS, stacks: 3 } },
    assetKey: 'card-filing_cabinet+',
  },
  // 官僚主义
  {
    ...
    rarity: CardRarity.Epic,
    cost: 2,
    description: '每回合开始时获得 1 层流程。',
    effect: { special: 'gain_process_each_turn_1' },
  ...
  // 备忘录风暴
  {
    ...
    cost: 2,
    description: '造成 5 点伤害 3 次，每层流程增加 2 点伤害。',
    effect: { damage: 5, special: 'multi_hit_3_damage_per_process_2' },
  ...
  },
  {
    ...
    rarity: CardRarity.Legendary,
    cost: 2,
    description: '造成 7 点伤害 3 次，每层流程增加 3 点伤害。',
    effect: { damage: 7, special: 'multi_hit_3_damage_per_process_3' },
    assetKey: 'card-memo_storm+',
  },
  // 效能审查
  {
    ...
    rarity: CardRarity.Legendary,
    cost: 1,
    description: '消耗所有流程，每层回复 3 点生命。',
    effect: { special: 'consume_process_heal_3' },
  ...
  },
  {
    ...
    rarity: CardRarity.Legendary,
    cost: 1,
    description: '消耗所有流程，每层回复 5 点生命。',
    effect: { special: 'consume_process_heal_5' },
    assetKey: 'card-efficiency_review+',
  },
];
...
const DATA_CARDS: Card[] = [
  // 数据核对（新增普通攻击牌）
  {
    ...
    rarity: CardRarity.Common,
    cost: 1,
    description: '造成 6 点伤害，每层核算增加 2 点伤害。',
    effect: { damage: 6, special: 'damage_per_audit_2' },
    upgradedId: 'data_verify+',
    assetKey: 'card-data_verify',
  },
  {
    id: 'data_verify+',
    name: '数据核对+',
    ...
    rarity: CardRarity.Common,
    cost: 1,
    description: '造成 9 点伤害，每层核算增加 3 点伤害。',
    effect: { damage: 9, special: 'damage_per_audit_3' },
    assetKey: 'card-data_verify+',
  },
  // 做报表
  {
  ...
  },
  {
    ...
    rarity: CardRarity.Common,
    cost: 1,
    description: '获得 3 层核算，抽 2 张牌。',
    effect: { applyBuff: { name: BUFFS.AUDIT, stacks: 3 }, drawCards: 2 },
    assetKey: 'card-make_report+',
  },
  // 记账
  {
    ...
    rarity: CardRarity.Common,
    cost: 1,
    description: '获得 6 点护甲，获得 2 层核算。',
    effect: { block: 6, applyBuff: { name: BUFFS.AUDIT, stacks: 2 } },
  ...
  },
  {
    ...
    rarity: CardRarity.Common,
    cost: 1,
    description: '获得 9 点护甲，获得 2 层核算。',
    effect: { block: 9, applyBuff: { name: BUFFS.AUDIT, stacks: 2 } },
    assetKey: 'card-bookkeeping+',
  },
  // 对账
  {
  ...
  // 盘点
  {
    ...
    rarity: CardRarity.Rare,
    cost: 1,
    description: '造成 5 点伤害，手牌每有 1 张牌增加 1 点伤害。',
    effect: { damage: 5, special: 'damage_per_hand_card_1' },
  ...
  },
  {
    ...
    rarity: CardRarity.Rare,
    cost: 1,
    description: '造成 7 点伤害，手牌每有 1 张牌增加 2 点伤害。',
    effect: { damage: 7, special: 'damage_per_hand_card_2' },
    assetKey: 'card-inventory_check+',
  },
  // 财务报表
  {
...
export const IT_CARDS: Card[] = [
  // 紧急修复（新增普通攻击牌）
  {
    ...
    rarity: CardRarity.Common,
    cost: 1,
    description: '造成 5 点伤害，每层加班增加 2 点伤害。',
    effect: { damage: 5, special: 'damage_per_overwork_2' },
    upgradedId: 'hotfix+',
    assetKey: 'card-hotfix',
  },
  {
    id: 'hotfix+',
    name: '紧急修复+',
    ...
    rarity: CardRarity.Common,
    cost: 1,
    description: '造成 8 点伤害，每层加班增加 3 点伤害。',
    effect: { damage: 8, special: 'damage_per_overwork_3' },
    assetKey: 'card-hotfix+',
  },
  // 代码攻击
  {
    ...
    rarity: CardRarity.Common,
    cost: 1,
    description: '造成 8 点伤害，获得 2 层加班。',
    effect: { damage: 8, applyBuff: { name: BUFFS.OVERWORK, stacks: 2 } },
  ...
  },
  {
    ...
    rarity: CardRarity.Common,
    cost: 1,
    description: '造成 12 点伤害，获得 2 层加班。',
    effect: { damage: 12, applyBuff: { name: BUFFS.OVERWORK, stacks: 2 } },
    assetKey: 'card-code_attack+',
  },
  // 系统防御
  {
